...
public class StatusMdoThreadAcceptanceTest extends AbstractAcceptanceTest {
    private static final Logger logger = LoggerFactory.getLogger(StatusMdoThreadAcceptanceTest.class);

    @Test
    public void statusMdoThreadAcceptance() {
        logger.info("statusMdoThreadAcceptance");
        ...
        Assert.assertEquals(time.getText().trim(), "09.05.16 07:54:21\n" +
                "Start\n" +
                "11min 28s\n" +
                "Duration\n" +
                DateUtils.date("2016-05-09 06:05:50", DEFAULT_SHORT_DATE_LONG_TIME_FORMAT) + "\n" +
                "End");
        ...
        breadcrumbManager.checkBreadcrumb(Arrays.asList("Frd", "1605009_25u_450m_5.3t", "NON_PRODUCTIVE", "MDO_THREAD"));

        //timeline tooltip
        Assert.assertEquals(applicationManager.getTooltipContainerText("*[uid='threading:3A160509055303325:1462773261758:1462773950349']"), "MDO_THREAD\n" +
                "3A16050905530332511 min");
