...
import static de.brueckner.fph.managers.TimelineManager.UNDER_3DAYS_DROPDOWN;

public class TimelineRenderingUnder3DaysAcceptanceTest extends AbstractAcceptanceTest {

    private static final Logger logger = LoggerFactory.getLogger(TimelineRenderingUnder3DaysAcceptanceTest.class);

    @Test
    public void timelineRenderingUnder3DaysAcceptanceTest() {
        logger.info("TimelineRenderingUnder3DaysAcceptanceTest");
        applicationManager.loginPage(LoginCredentials.USER_DEV.getUsername(), LoginCredentials.USER_DEV.getPassword());

        timelineManager.setNewDateForDatePicker("2016-04-12 22:00:00", "2016-04-14 21:59:00");
        ...
        WebLocator pos3 = new WebLocator().setText("160411_11T23u_400m_4.3t").setRenderMillis(10000);
        pos3.assertReady();


        //change from campaign to prod/non-prod
        timelineManager.timelineSettingsSetDropdownOption(UNDER_3DAYS_DROPDOWN, PROD_NONPROD_DROPDOWN_OPTION);

        //check position 1 to be a campaign
        pos1 = new WebLocator().setText("160411_11T23u_400m_4.3t").setRenderMillis(10000);
        pos1.assertReady();
