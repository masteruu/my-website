...
public class TimelineRenderingUnder24HoursAcceptanceTest extends AbstractAcceptanceTest {

    private static final Logger logger = LoggerFactory.getLogger(TimelineRenderingUnder24HoursAcceptanceTest.class);

    @Test
    public void timelineRenderingUnder24HoursAcceptanceTest() {
        logger.info("TimelineRenderingUnder24HoursAcceptanceTest");
        applicationManager.loginPage(LoginCredentials.USER_DEV.getUsername(), LoginCredentials.USER_DEV.getPassword());

        //set the selection to under 3 months
        timelineManager.setNewDateForDatePicker("2016-04-10 10:00:00", "2016-04-10 20:00:00");
        ...
        WebLocator pos3 = new WebLocator().setText("A 160410 2232").setRenderMillis(10000);
        pos3.assertReady();
        ...
        pos3 = new WebLocator().setText("10").setRenderMillis(10000);
        pos3.assertReady();
