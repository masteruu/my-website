...
public class HeaderButtonGoToNowAcceptanceTest extends AbstractCampaignManagerTest {

    private static final Logger logger = LoggerFactory.getLogger(HeaderButtonGoToNowAcceptanceTest.class);

    @Test
    public void headerButtonGoToNowAcceptanceTest() {

        logger.info("HeaderButtonGoToNowAcceptanceTest");
        applicationManager.loginPage(LoginCredentials.USER_DEV.getUsername(), LoginCredentials.USER_DEV.getPassword());

        campaignManager.open();
        campaignManager.goToNowButton();
