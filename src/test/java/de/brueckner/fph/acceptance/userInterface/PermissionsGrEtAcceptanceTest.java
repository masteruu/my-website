...
public class PermissionsGrEtAcceptanceTest extends AbstractAcceptanceTest {
    private static final Logger logger = LoggerFactory.getLogger(PermissionsGrEtAcceptanceTest.class);
    ...
    public void canAccessApplicationSettingsLowSettings() {
        logger.info(LoginCredentials.USER_ET.getUsername() + " can access application settings low");

        applicationManager.loginPage(LoginCredentials.USER_ET.getUsername(), LoginCredentials.USER_ET.getPassword());
    ...
    public void cantAccessApplicationSettingsHighSettings() {
        logger.info(LoginCredentials.USER_ET.getUsername() + " can't access application settings high");
    ...
    public void canAccessStateReport() {
        logger.info(LoginCredentials.USER_ET.getUsername() + " can access state report");
    ...
    public void canCreateEditNote() {
        ...
        logger.info(LoginCredentials.USER_ET.getUsername() + " can create/edit note");
    ...
    public void canChangeRollWeight() {
        ...
        logger.info(LoginCredentials.USER_ET.getUsername() + " can change roll weight");
    ...
    public void canAddRollNote() {
        ...
        logger.info(LoginCredentials.USER_ET.getUsername() + " can add roll note");
    ...
    public void canChangeVisualQuality() {
        ...
        logger.info(LoginCredentials.USER_ET.getUsername() + " can change visual quality");
    ...
    public void canAccessCampaignManager() {
        ...
        logger.info(LoginCredentials.USER_ET.getUsername() + " can access campaign manager");
    ...
    public void canAddPrivateNote() {
        ...
        logger.info(LoginCredentials.USER_ET.getUsername() + " can add private note");
