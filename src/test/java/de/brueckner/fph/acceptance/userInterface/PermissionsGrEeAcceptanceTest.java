...
public class PermissionsGrEeAcceptanceTest extends AbstractAcceptanceTest {
    private static final Logger logger = LoggerFactory.getLogger(PermissionsGrEeAcceptanceTest.class);
    ...
    public void canAccessApplicationSettingsLowSettings() {
        logger.info(LoginCredentials.USER_EE.getUsername() + " can access application settings low");

        applicationManager.loginPage(LoginCredentials.USER_EE.getUsername(), LoginCredentials.USER_EE.getPassword());
    ...
    public void cantAccessApplicationSettingsHighSettings() {
        logger.info(LoginCredentials.USER_EE.getUsername() + " can't access application settings high");
    ...
    public void canAccessStateReport() {
        logger.info(LoginCredentials.USER_EE.getUsername() + " can access state report");
    ...
    public void canCreateEditNote() {
        ...
        logger.info(LoginCredentials.USER_EE.getUsername() + " can create/edit note");
    ...
    public void canChangeRollWeight() {
        ...
        logger.info(LoginCredentials.USER_EE.getUsername() + " can change roll weight");
    ...
    public void canAddRollNote() {
        ...
        logger.info(LoginCredentials.USER_EE.getUsername() + " can add roll note");
    ...
    public void canChangeVisualQuality() {
        ...
        logger.info(LoginCredentials.USER_EE.getUsername() + " can change visual quality");
    ...
    public void canChangeLaboratoryQuality() {
        ...
        logger.info(LoginCredentials.USER_EE.getUsername() + " can change laboratory quality");
    ...
    public void canAccessCampaignManager() {
        ...
        logger.info(LoginCredentials.USER_EE.getUsername() + " can access campaign manager");
    ...
    public void canAddPrivateNote() {
        ...
        logger.info(LoginCredentials.USER_EE.getUsername() + " can add private note");
